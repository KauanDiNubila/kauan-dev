...
export function Contact() {
  ...
  return (
    <div id="contato" className="border-t border-border">
      ...
      >
        <p className="mb-2.5 text-[13px] font-semibold text-primary">05 / contato</p>
        <h2 className="mb-3.5 text-[32px] font-bold">Contato</h2>
        <p className="mb-8 text-[15px] text-[#5A5A54]">Acompanhe meu trabalho e entre em contato pelas redes abaixo.</p>
